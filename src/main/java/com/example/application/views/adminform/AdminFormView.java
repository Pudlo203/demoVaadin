package com.example.application.views.adminform;
...
@PageTitle("AdminForm")
@Route(value = "AdminForm", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AdminFormView extends Div {
    ...
    public AdminFormView(SampleAddressService addressService) {
